...
namespace Nulah.Users.Models {
    ...
    public class User {
        ...
        /// <summary>
        ///     Name of the provider being used for login, defined from AppSettings.json
        /// </summary>
        public string Provider { get; set; }
        /// <summary>
        ///     Abbreviated Provider name for prefixes
        /// </summary>
        public string ProviderShort { get; set; }
        /// <summary>
        ///     Name supplied from OAuth Provider
        /// </summary>
        public string Name { get; set; }
        /// <summary>
        ///     Login Name supplied from OAuth Provider, used as a fallback if Name is null
        /// </summary>
        public string Login { get; set; }

        /// <summary>
        ///     DateTime in UTC that the user last logged in/"was seen"
        /// </summary>
